        ...
        <form onSubmit={handleDeleteSubmit} className="space-y-4">
          <div className="p-4 bg-rose-50 border border-rose-150 rounded-xl flex items-start gap-3 text-xs text-rose-800 leading-normal">
            ...
            <div>
              ...
              Este lançamento deixará de ser somado e contabilizado no saldo de combustível do tanque desta fazenda. No entanto, o registro continuará visível no histórico geral de remoções (na aba Configurações) para fins de auditoria e transparência.
            </div>
          </div>
