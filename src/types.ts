...
export type UserRole = 'admin' | 'control' | 'fuel' | 'mechanic' | 'registered' | 'editor' | 'viewer';
...
export interface Checklist30d {
  ...
  hour_km: number;
  work_type?: string;
  overall_status: 'OK' | 'Prioridade Baixa' | 'Prioridade Média' | 'Prioridade Alta (Máquina Parada)' | 'Necessita Atenção' | 'Máquina Parada';
